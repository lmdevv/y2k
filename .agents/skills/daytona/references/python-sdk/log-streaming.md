...
For more information, see the [Python SDK](./sync/process.md), [TypeScript SDK](../typescript-sdk/process.md), [Ruby SDK](../ruby-sdk/process.md), [Go SDK](../go-sdk/README.md), and [API](../api/README.md#daytona-toolbox/tag/process) references.

> [**get_session_command_logs_async (Python SDK)**](./sync/process.md#processget_session_command_logs_async)
>
...
> [**get_session_command_logs (Python SDK)**](./sync/process.md#processget_session_command_logs)
>
> [**getSessionCommandLogs (TypeScript SDK)**](../typescript-sdk/process.md#getsessioncommandlogs)
>
